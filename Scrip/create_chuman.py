...
parser.add_argument('--base_dir', default=r'/home/yetian/Project/Iter-Deformable-DETR/crowdhuman',help='Path to the root directory of the dataset')
parser.add_argument('--save_prepend', default=r'/home/yetian/Project/CrowdCounting-P2PNet/HeadHunter/crowdhuman',help='Places where files for detection are saved')
